...
<body>
    <div class="frame">
        <h2 style="text-align: center;">설문지 (수정용)</h2>
        ...
        <form method="POST" action="./updateReply.php?sid=<?= $sid ?>" method="POST"> <!--action="/action_page.php" -->
            <label for="sname">1.이름 : <?= $sname ?></label>
            <label for="snum">2.학번 : <?= $sid ?></label>
            <label for="sdept">3.학과이름(전공) : <?= $sdept ?></label>
            <br><br>
            ...
            <br><br><input style="margin:auto; display:block;" type="submit" value="수정">
        </form>
